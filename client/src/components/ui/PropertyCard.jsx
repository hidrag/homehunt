...
const PropertyCard = ({ property }) => {
  ...
  return (
    <Link to={`/listings/${property._id}`} className="group block overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm transition-all hover:shadow-md">
      ...
      <div className="p-5">
        <div className="mb-2 flex items-center justify-between">
          ...
          <p className="text-sm font-medium text-gray-500 capitalize">{property.propertyType}</p>
        </div>
        
        <h3 className="mb-2 truncate text-lg font-semibold text-gray-800" title={property.title}>
          {property.title}
        </h3>
